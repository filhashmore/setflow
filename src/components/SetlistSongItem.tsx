  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="drag-handle flex items-center justify-center w-6 h-6 text-muted-foreground hover:text-foreground touch-target shrink-0"
      >
      ...
      <div className="flex-1 min-w-0 flex flex-col gap-0.5">
        ...
        <div className="flex items-center gap-2 text-xs text-muted-foreground">
          <span className="font-mono-display">{formatDuration(song.durationSeconds)}</span>
