...
export function SongPicker({
  ...
  return (
    <Drawer open={open} onOpenChange={setOpen}>
      ...
      <DrawerContent className="h-[85vh] max-h-[85vh]" onInteractOutside={(e) => e.preventDefault()}>
        <DrawerHeader className="border-b border-border pb-3 relative">
          ...
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 rounded-sm opacity-70 hover:opacity-100 p-1"
          >
            <X className="h-5 w-5" />
